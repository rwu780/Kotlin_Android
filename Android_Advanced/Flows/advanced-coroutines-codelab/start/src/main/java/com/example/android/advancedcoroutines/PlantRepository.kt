...
class PlantRepository private constructor(
    ...
    val plantsFlow: Flow<List<Plant>>
        get() = plantDao.getPlantsFlow().combine(customSortFlow) {
            plants, sortOrder -> plants.applySort(sortOrder)
        }
    ...
    fun getPlantsWithGrowZone(growZone: GrowZone) =
        plantDao.getPlantsWithGrowZoneNumber(growZoneNumber = growZone.number)
            .switchMap { plantList ->
                liveData {
                    val customSortOrder = plantsListSortOrderCache.getOrAwait()
...
//        liveData {
//        val plantsGrowZoneLiveData = plantDao.getPlantsWithGrowZoneNumber(growZoneNumber = growZone.number)
//        val customSortOrder = plantsListSortOrderCache.getOrAwait()
...
//        plantDao.getPlantsWithGrowZoneNumber(growZone.number)
    ...
    private fun List<Plant>.applySort(customSortOrder: List<String>): List<Plant>{
        return sortedBy { plant ->
            val positionForItem = customSortOrder.indexOf(plant.plantId).let {
                    order ->
