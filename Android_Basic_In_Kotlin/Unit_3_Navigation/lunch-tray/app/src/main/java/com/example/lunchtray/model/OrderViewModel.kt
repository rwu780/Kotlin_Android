...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        _entree.value = menuItems.filter { (_, item) -> item.type == ItemType.ENTREE }[entree]

        updateSubtotal(_entree.value!!.price)

    }

    private fun findMenuItemOnName(entree: String): MenuItem?{
    ...
    fun setSide(side: String) {
        ...
        _side.value = menuItems.filter { (_, item) -> item.type == ItemType.SIDE_DISH }[side]
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        _accompaniment.value = menuItems.filter { (_, item) -> item.type == ItemType.ACCOMPANIMENT }[accompaniment]
